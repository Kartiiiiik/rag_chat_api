export async function parseDocument(file: File): Promise<string> {
  ...
  // For PDF files, we'll show a placeholder message since client-side PDF parsing
  // has build compatibility issues. In production, use a backend service for PDF parsing.
